(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (skillsContainer) {
      ...
      let activeFilter = select('#skills-flters .filter-active');
  ...
  /**
   * Initiate skills lightbox 
   */
  const skillsLightbox = GLightbox({
    selector: '.skills-lightbox'
  });

  /**
   * Initiate skills details lightbox 
   */
  const skillsDetailsLightbox = GLightbox({
    selector: '.skills-details-lightbox',
    width: '90%',
    height: '90vh'
  });

  /**
   * skills details slider
   */
  new Swiper('.skills-details-slider', {
    speed: 400,
    loop: true,
    autoplay: {
      delay: 5000,
   ...
   * applications slider
   */
  new Swiper('.applications-slider', {
    speed: 600,
    loop: true,
    autoplay: {
      delay: 5000,
